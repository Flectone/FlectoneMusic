...
public class CookieUtils {
    ...
    public static void saveCookies() {
        try {
            ...
            Files.writeString(Paths.get(Config.COOKIES.getName()), json);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void loadCookies() {
        try {
            ...
            File file = new File(Config.COOKIES.getName());
            if (!file.exists()) file.createNewFile();

            byte[] bytes = Files.readAllBytes(Paths.get(Config.COOKIES.getName()));
            ...
            if (cookiesToLoad == null) cookiesToLoad = new HashMap<>();
